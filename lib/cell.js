var Errors = require('spore-errors'),
    ...
    fs = require('fs-extra'),
    LocalOnly = require('./shared/local_only');

module.exports = Cell;

function Cell(env, key, id) {
  mixin(this, LocalOnly);
...
Cell.prototype.localOnlyPath = function () {
...
Cell.prototype.cellFileFormat = Cell.prototype.localOnlyFormat = function () {
  return {
    id: this.id,
    value: this.value(),
    key: this.key,
...
Cell.prototype._localSave = function (contents, callback) {
  var self = this;
...
Cell.prototype._remoteSaveLocal = function (contents, callback) {
  var self = this;
  ...
  this.api(function (err, api) {
    ...
    api.cells.create(self.remotePath(), contents, function (err) {
...
Cell.prototype._localLoad = function (callback) {
  var self = this;
...
Cell.prototype._remoteLoad = function (callback) {
  var self = this;
