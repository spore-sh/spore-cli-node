...
SporeConfig.prototype.cellPath = function (appId, envName, cellId) {
  return resolvePath(this.envPath(appId, envName), cellId);
};

SporeConfig.prototype.envPath = function (appId, envName) {
  return resolvePath(this.appPath(appId), envName);
};

SporeConfig.prototype.appPath = function (appId) {
  return resolvePath(this.appsPath(), appId);
};
