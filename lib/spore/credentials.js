...
module.exports = SporeCredentials;

function SporeCredentials() {}

SporeCredentials.prototype.signup = function (email, password, callback) {
  var self = this;
...
SporeCredentials.prototype.login = function (email, password, callback) {
  var self = this;
...
SporeCredentials.prototype.setKey = function (email, key, callback) {
  var self = this;
...
SporeCredentials.prototype.getKey = function (callback) {
  var self = this;
