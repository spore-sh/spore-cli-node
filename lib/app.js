...
SporeApp.prototype._create = function (name, envNames) {
  ...
  // mark this app as only existing locally so that we can
  // save it to the server later
  this.localOnly = true;
...
SporeApp.prototype.saveSporeFile = function (callback) {
  ...
  this.spore.sporeFile(function (err, sporeFile) {
    var sporeFilePath = resolvePath(this.dir, sporeFile);
...
SporeApp.prototype.saveAppFile = function (callback) {
  var self = this,
      appPath = this.path();

  this.spore.appFile(function (err, appFile) {
...
SporeApp.prototype.saveRemote = function (callback) {
  ...
  this.api(function (err, api) {
    ...
    api.createApp(self.id, self.remoteFormat, function (err) {
...
SporeApp.prototype.remoteFormat = function () {
  return {
    name: this.name
  };
};
