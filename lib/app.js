...
App.prototype.localOnlyPath = function () {
...
App.prototype._saveRemote = function (callback) {
  var self = this;
  ...
  this.api(function (err, api) {
    ...
    api.apps.create(self.remotePath(), self.remoteFormat(), function (err) {
...
App.prototype.remoteFormat = App.prototype.localOnlyFormat = function () {
  return {
    name: this.name
  };
};
